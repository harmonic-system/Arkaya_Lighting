          ...
          <div className="row">
            <Link to="/commercial" className="col-xl-4 col-lg-4 col-md-4 col-sm-12">
              <div className="products-image-box">
                <img alt="Commercialscategory-image" src="images/products/Architecture/Commercials.png" />
                <h3>Commercials</h3>
              </div>
            </Link>
            <Link to="/dynamicfacade" className="col-xl-4 col-lg-4 col-md-4 col-sm-12">
              <div className="products-image-box">
                <img alt="Dynamicfacadecategory-image" src="images/products/Architecture/Dynamicfacade.jpg" />
                <h3>Dynamic Facade</h3>
              </div>
            </Link>
            <Link to="/landscapes" className="col-xl-4 col-lg-4 col-md-4 col-sm-12">
              <div className="products-image-box">
                <img alt="Landscapescategory-image" src="images/products/Architecture/Landscapes.jpg" />
                <h3>Landscapes</h3>
              </div>
            </Link>
            <Link to="/museums" className="col-xl-4 col-lg-4 col-md-4 col-sm-12">
              <div className="products-image-box">
                <img alt="museumscategory-image" src="images/products/Architecture/museums.jpg" />
                <h3>Museums</h3>
              </div>
            </Link>
            <Link to="/residential" className="col-xl-4 col-lg-4 col-md-4 col-sm-12">
              <div className="products-image-box">
                <img alt="residentialscategory-image" src="images/products/Architecture/residentials.avif" />
                <h3>Residentials</h3>
              </div>
            </Link>
          </div>
