                ...
                <div className="products-image">
                    ...
                    <div className="container">
                        <div className="grid grid-three-column">
                            <Link to="/products" onClick={() => setCategoryinlocalStorage("Flood Lights")}>
                                <div className="products-image-box">
                                    <img src="./images/products/Architecture/temp/flood-light.jpg" alt="floodlightcategoryimage" />
                                    <h3>Flood Lights</h3>
                                </div>
                            </Link>
                            <Link to="/products" onClick={() => setCategoryinlocalStorage("Under Ground Lights")}>
                                <div className="products-image-box">
                            ...
                            <Link to="/products" onClick={() => setCategoryinlocalStorage("Under Water Lights")}>
                                <div className="products-image-box">
