          ...
          <tbody>
            {allQuerry?.map((query) => (
              <tr key={query?._id}>
                <td>{count++}</td>
                <td>{query?.name}</td>
                <td>{query?.productCode}</td>
                <td>{query?.productName}</td>
                <td>{query?.productSKU}</td>
                <td>{query?.email}</td>
                <td>{query?.phone}</td>
                <td className="description">{query?.query}</td>
                <td>
                  <button
                    type="button"
...
export default AdminQuerry

const AdminQuerryWrapper = styled.section`
/* Container */
.admin-container {
  margin: 2rem 0;
  width: 100%;
