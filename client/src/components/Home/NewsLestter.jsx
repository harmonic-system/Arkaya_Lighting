                    ...
                    <div className="newsletter-container">
                        <div className="newsletter">
                            <form onSubmit={handleNewsletter}>
                                <input className="" placeholder="Enter Your Email To Subscribe" type="email" name="newsletteremail" required onChange={handleNewsletterInput} value={newsubscriber.newsletteremail} />
