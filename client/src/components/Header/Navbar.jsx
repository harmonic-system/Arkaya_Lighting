...
const getLogoPath = () => {
  return window.location.pathname === "/"
    ? "./images/arkaya-logo-transformed.png"
    : "../images/arkaya-logo-transformed.png";
};
            ...
            <ul className={`nav-links ${menuOpen ? "open" : ""}`}>
                  ...
                  <div className="content">
                    ...
                    <div className="pro">
                      ...
                      <ul className="mega-links">
                        <li><Link to="/temparchitecture" onClick={closeMenu}>Architecture</Link></li>
              ...
              <li>
                ...
                <ul className="drop-menu">
                  ...
                  <li><Link to="/" onClick={() => setMenuOpen(false)}>DataSheet</Link></li>
                  <li><Link to="/" onClick={() => setMenuOpen(false)}>Solution Support</Link></li> */}
                </ul>
              </li>
              ...
              <li>
                {isAuthenticated ? (
                  <span>
                    <Link className="desktop-item">
                      {user?.name?.length < 10
                        ...
                        : user?.name?.slice(0, 10).toUpperCase()}
                    </Link>
                    <input type="checkbox" id="showDrop-profile" />
                    <label htmlFor="showDrop-profile" className="mobile-item">
                      {user?.name?.length < 10
                        ? user?.name?.toUpperCase()
                        : user?.name?.slice(0, 10).toUpperCase()}
                    </label>
                  ...
                  <Link to="/login" className="button" onClick={closeMenu}>
                    {/* <Button>LOGIN</Button> */}
                    LOGIN
                  </Link>
                )}
              ...
              <li>{user?.isAdmin && <Link to="/admin" onClick={closeMenu}>Admin Section</Link>}</li>
            </ul>
